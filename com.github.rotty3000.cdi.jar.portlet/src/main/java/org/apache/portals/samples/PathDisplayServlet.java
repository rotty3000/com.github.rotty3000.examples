 ...
 *
 */
@PathDisplayServlet.ServiceProperties(
	context_select = "(osgi.http.whiteboard.context.path=/com.github.rotty3000.cdi.jar.portlet)",
	servlet_name = "Bob",
	servlet_pattern = "/Named/Bob/*"
)
...
public class PathDisplayServlet extends HttpServlet {
	...
	public static @interface ServiceProperties {
		String PREFIX_ = "osgi.http.whiteboard.";
		String context_select();
		String servlet_name();
		String servlet_pattern();
	}

   private static final long serialVersionUID = -7767947528599563527L;

   private static final String JSP = "/jsp/pathinfo.jsp?mix1=svtqval1&svtqp3=svtqval3&mix2=svtqval2";
