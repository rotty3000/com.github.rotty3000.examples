...
public class HelloWorldImage {
   ...
   private final static String[] chimps = new String[] {
      "/images/BabyChimp.gif",
      "/images/bonoboMomKid.gif",
      "/images/Chimpanzee_thinking-small.gif",
      "/images/ChimpEatingDollar.gif"
   };
    ...
    */
   @ServeResourceMethod(portletNames={"BeanPortlet"}, include="/jsp/res-simple.jsp")
